...
public class JoyconManager: MonoBehaviour
{
    ...
    //private const ushort vendor_id = 0x45e;
    //private const ushort vendor_id_ = 0x045e;
    private const ushort product_l = 0x2006;
    private const ushort product_r = 0x2007;
    private const ushort product_p = 0x2009;
    //private const ushort product_p = 0x028e;
    ...
    void Awake()
    {
		...
		while (ptr != IntPtr.Zero) {
			...
			Debug.Log (enumerate.product_id);
				if (enumerate.product_id == product_l || enumerate.product_id == product_r || enumerate.product_id == product_p) {
